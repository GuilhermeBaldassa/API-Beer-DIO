...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Guilherme Baldassa";
    private static final String CONTACT_GITHUB = "https://github.com/Gui-dev21/API-Beer-DIO.git";
    private static final String CONTACT_EMAIL = "guilherme.baldassa@gmail.com";
